...
const RegistrationElements_1 = require("./RegistrationElements");
...
const Register = () => {
    const registrationID = (0, genID_1.default)(1000, 9999);
    const firstNameRef = (0, react_1.useRef)();
    ...
    const handleSubmit = (e) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const res = yield fetch(REGISTER_URL, {
                method: "post",
                headers: {
    ...
    return (React.createElement(React.Fragment, null, success ? (React.createElement(RegistrationElements_1.ExContainer, null,
        React.createElement(framer_motion_1.motion.div, { initial: 'initial', animate: 'in', exit: 'out', variants: Animation_1.pageVariants, transition: Animation_1.pageTrans, style: Animation_1.pageStyle },
            React.createElement(RegistrationElements_1.Registered, null,
                React.createElement("h1", null, "Your registration has been successful!"),
                React.createElement("p", null,
                    "Thank you for your early registion ",
                    firstName,
                ...
                React.createElement(NavBarElements_1.NavBtnLink, { className: 'NavBtnLink', to: '/Contact' }, "Contact Us"))))) : (React.createElement(RegistrationElements_1.ExContainer, null,
        React.createElement(framer_motion_1.motion.div, { initial: 'initial', animate: 'in', exit: 'out', variants: Animation_1.pageVariants, transition: Animation_1.pageTrans, style: Animation_1.pageStyle },
            React.createElement(RegistrationElements_1.Section, null,
                React.createElement("h1", null, "Pre-Launch Early Registration"),
                React.createElement("p", null,
                ...
                React.createElement(RegistrationElements_1.Form, { onSubmit: handleSubmit },
                    ...
                    React.createElement("label", null,
                        "Email:",
                        React.createElement("input", { type: 'text', placeholder: 'Enter your email', id: 'email', autoComplete: 'off', onChange: (e) => setEmail(e.target.value), value: email, required: 'true' })),
                    React.createElement("br", null),
                    React.createElement("label", null,
                        "Contact Number:",
                    ...
                    React.createElement("label", null,
                        "Keep me in the loop",
                        React.createElement(RegistrationElements_1.CheckBox, { type: 'checkbox', className: "checkBox", id: 'keepUpdated', autoComplete: 'off', onChange: (e) => setKeepUpdated(e.target.value) })),
